...
void main() {
  ...
  test(
    'v41-baseline database upgraded through v66 matches a fresh v66 create',
    () async {
      // Fresh v66: DatabaseHelper's real _onCreate path, on a database file
      ...
      expect(
        ...
        reason:
            ...
            'fresh v66 database, otherwise this test would vacuously pass',
      );
