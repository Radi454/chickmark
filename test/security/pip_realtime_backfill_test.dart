...
void main() {
  ...
  test(
    'Realtime migration backfills legacy agent rows correctly',
    () async {
      final result = await Process.run(
        'bash',
        ['scripts/test_pip_realtime_backfill.sh'],
        environment: {
      ...
      expect(
        result.stdout,
        contains('Pip Realtime V1 backfill integration checks passed.'),
      );
    },
