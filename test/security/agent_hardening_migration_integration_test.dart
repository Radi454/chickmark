...
void main() {
  ...
  test(
    'migration succeeds without optional farm and customer-sector tables',
    () async {
      final result = await Process.run(
        'bash',
        ['scripts/test_agent_hardening_migration.sh'],
        environment: {
      ...
      expect(
        result.stdout,
        contains('Agent hardening migration compatibility checks passed.'),
      );
    },
