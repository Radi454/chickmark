...
const Map<String, String> _ar = {
  ...
  'Agent health': 'حالة الوكيل',
  'Needs attention': 'تحتاج إلى متابعة',
  'Healthy': 'سليم',
  'Conversations': 'المحادثات',
  'Delivery errors': 'أخطاء الإرسال',
  'Pending replies': 'ردود معلّقة',
  'Tool errors': 'أخطاء الأدوات',
  'Flocks missing sector': 'قطعان بلا قطاع',
  'No synchronized conversations yet.': 'لا توجد محادثات متزامنة حتى الآن.',
  ...
  'A customer can use multiple sectors. Each flock belongs to exactly one enabled sector.':
      'يمكن للعميل استخدام عدة قطاعات، وينتمي كل قطيع إلى قطاع مفعّل واحد فقط.',
  ...
  'Enable Breeder, Broiler, or Layer before adding flocks.':
      'فعّل قطاع الأمهات أو التسمين أو البيّاض قبل إضافة القطعان.',
  ...
  'Reason for closing': 'سبب الإغلاق',
  'No performance alerts for this flock.': 'لا توجد تنبيهات أداء لهذا القطيع.',
  'Official guide limit': 'حد رسمي من الدليل',
  'App-defined threshold': 'حد خاص بالتطبيق',
  'Period': 'الفترة',
  'Official target': 'الهدف الرسمي',
  'Deviation': 'الانحراف',
  ...
  'Review data quality. Registry checks need attention; save is still allowed.':
      'راجع جودة البيانات. تحتاج فحوصات السجل إلى الانتباه، ولا يزال الحفظ مسموحًا.',
  ...
  'Opening females': 'عدد الإناث الافتتاحي',
  'Opening males': 'عدد الذكور الافتتاحي',
  'Remove house': 'إزالة العنبر',
  'Isolation areas': 'مناطق العزل',
  'Isolation area name': 'اسم منطقة العزل',
  'Add isolation area': 'إضافة منطقة عزل',
  'Add another isolation area': 'إضافة منطقة عزل أخرى',
  'Remove isolation area': 'إزالة منطقة العزل',
  'Isolation': 'عزل',
  '(Isolation)': '(عزل)',
  ...
  'Dead %': 'نسبة النافق',
  'Sample size': 'حجم العينة',
  'New egg batch': 'دفعة بيض جديدة',
  'New shipment': 'شحنة جديدة',
  'Approve dispatch': 'اعتماد الشحن',
  'This will record one inventory movement for this shipment. Continue?':
      'سيتم تسجيل حركة مخزون واحدة لهذه الشحنة. هل تريد المتابعة؟',
  'Cancel shipment': 'إلغاء الشحنة',
  'Record receipt': 'تسجيل الاستلام',
  'Eggs received': 'عدد البيض المستلم',
  ...
  'Official Benchmarks': 'المعايير الرسمية',
  // BMK screen sector tabs.
  'Search customers': 'ابحث عن العملاء',
  'Breeder Farm': 'مزرعة الأمهات',
  // BMK screen — Breeder Farm sector.
  'Breeder Benchmarks': 'معايير الأمهات',
  'Production BMK': 'معايير الإنتاج',
  'Liveability & Fertility': 'الحيوية والخصوبة',
  'Female': 'أنثى',
  'Male': 'ذكر',
  'Weekly': 'أسبوعي',
  'View full tables': 'عرض الجداول الكاملة',
  'Open source': 'فتح المصدر',
  'Could not open the source link.': 'تعذر فتح رابط المصدر.',
  'Published': 'تاريخ النشر',
  'Published breed-company performance targets':
      'أهداف الأداء المنشورة من شركة السلالة',
  'No published benchmark profiles yet.': 'لا توجد ملفات معايير منشورة بعد.',
  'Age (d)': 'العمر (يوم)',
  'Age (wk)': 'العمر (أسبوع)',
  'Prod. wk': 'أسبوع الإنتاج',
  'Sex': 'الجنس',
  'Not stated': 'غير مذكور',
  // Breeder daily report (breeder-flock-performance ticket 07).
  'Breeder Performance': 'أداء القطيع الأمهات',
  'Daily Report Entry': 'إدخال التقرير اليومي',
  'Daily Report Review': 'مراجعة التقرير اليومي',
  'Report header': 'بيانات التقرير',
  // Daily-report sync conflict resolution (breeder-flock-performance
  // ticket 15).
  'Resolve': 'حل',
  ...
  'Mortality': 'النفوق',
  'Culls/Sorts': 'الاستبعاد/الفرز',
  'Sale': 'البيع',
  'Kitchen removal': 'سحب للمطبخ',
  'Kitchen': 'المطبخ',
  'Euthanasia': 'الإعدام الرحيم',
  'Transfer in': 'تحويل وارد',
  'Transfer out': 'تحويل صادر',
  'Inside °': 'درجة الحرارة الداخلية',
  'Outside °': 'درجة الحرارة الخارجية',
  'State': 'الحالة',
  'Production week': 'أسبوع الإنتاج',
  'Pre-production': 'قبل الإنتاج',
  'This flock has no houses yet.': 'لا توجد عنابر لهذا القطيع بعد.',
  "No daily reports yet. Tap + to record today's report.":
      'لا توجد تقارير يومية بعد. اضغط + لتسجيل تقرير اليوم.',
  // Breeder egg production and grade partition (breeder-flock-performance
  // ticket 10).
  'Egg production': 'إنتاج البيض',
  'About this comparison': 'حول هذه المقارنة',
  // Breeder egg-inventory ledger (breeder-flock-performance ticket 11).
  'Egg inventory': 'مخزون البيض',
  'Previous balance': 'الرصيد السابق',
  "Today's production": 'إنتاج اليوم',
  'Available balance': 'الرصيد المتاح',
  'Dispatched to hatchery': 'مُرسل إلى المفرخة',
  'Gifts': 'هدايا',
  ...
  'Quantity': 'الكمية',
  'Reason': 'السبب',
  // Breeder flock overview (breeder-flock-performance ticket 18).
  'Could not load the flock overview.': 'تعذر تحميل نظرة عامة على القطيع.',
  'Current inventory': 'المخزون الحالي',
  'Daily Reports': 'التقارير اليومية',
  'Data completeness': 'اكتمال البيانات',
  'Egg Stock & Shipments': 'مخزون البيض والشحنات',
  'Feed': 'العلف',
  'Hen-Week Production': 'نسبة إنتاج Hen-Week',
  'Milestone-aligned': 'وفق علامة الإنتاج',
  'No egg grades are configured yet.': 'لم يتم إعداد فئات البيض بعد.',
  'No open alerts': 'لا توجد تنبيهات مفتوحة',
  'View all alerts': 'عرض كل التنبيهات',
  'Weighing': 'الوزن',
  'Weighing Sessions': 'جلسات الوزن',
  'Feed per female': 'العلف لكل أنثى',
  'Feed per male': 'العلف لكل ذكر',
  'Mean weight': 'متوسط الوزن',
  'Missing': 'مفقود',
  'No official benchmark for this breed': 'لا يوجد معيار رسمي لهذه السلالة',
  'No weighing sessions yet': 'لا توجد جلسات وزن بعد',
  'Total eggs': 'إجمالي البيض',
  'Total feed (kg)': 'إجمالي العلف (كجم)',
  'days': 'أيام',
  'wk': 'أسبوع',
