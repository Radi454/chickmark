class SetterMeasurements {
  ...
  String? setterId;
  int? incubationAge; // days

  // ── Govee BLE ambient readings ────────────────────────────────────────────
  double? temperature;
  double? humidity;

  // ── Eggshell temperature grid (3 × 3) ────────────────────────────────────
  ...
  factory SetterMeasurements.fromMap(Map<String, dynamic> m) =>
      SetterMeasurements(
        id: m['id'] as String,
        auditSessionId: m['audit_session_id'] as String,
        customerId: m['customer_id'] as String,
        flockId: m['flock_id'] as String,
        setterId: m['setter_id'] as String?,
        incubationAge: m['incubation_age'] as int?,
