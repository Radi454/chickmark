    ...
    ScopeSectorConfig(
      ...
      params: const [
        ScopeParam.percent(
          'Hatch %',
          'hatchabilityPct',
          bmkField: 'hatchabilityPct',
          higherIsBetter: true,
        ),
        ScopeParam.percent(
          'Fert %',
          'fertilityPct',
          bmkField: 'fertilityPct',
          higherIsBetter: true,
        ),
        ScopeParam.percent(
          'HOF %',
    ...
    ScopeSectorConfig(
      ...
      params: const [
        ScopeParam.percent(
          'Infert %',
          'infertilePct',
          countColumn: 'infertileCount',
          bmkField: 'infertilePct',
        ),
        ScopeParam.percent(
          '24h %',
          'early24hPct',
          countColumn: 'early24hCount',
          bmkField: 'early24hPct',
        ),
        ScopeParam.percent(
          '48h %',
          'early48hPct',
          countColumn: 'early48hCount',
          bmkField: 'early48hPct',
        ),
        ScopeParam.percent(
          'Blood ring %',
          'bloodRingPct',
          countColumn: 'bloodRingCount',
          bmkField: 'bloodRingPct',
        ),
      ],
    ),
    ScopeSectorConfig(
      ...
      params: const [
        ...
        ScopeParam.percent(
          'Black eye %',
          'blackEyePct',
          countColumn: 'blackEyeCount',
          bmkField: 'blackEyePct',
        ),
      ],
    ),
    ScopeSectorConfig(
      ...
      station: stationHatch,
      note: '21-day · 2 house × 2 machine × 2 trolley × 2 tray = 16 leaves.',
      tableName: 'residue_breakout',
      ...
      params: const [
        ...
        ScopeParam.percent(
          'Early %',
          'earlyDeadPct',
          countColumn: 'earlyDeadCount',
          bmkField: 'earlyDeadPct',
        ),
        ScopeParam.percent(
          'Mid %',
          'midDeadPct',
          countColumn: 'midDeadCount',
          bmkField: 'midDeadPct',
        ),
        ScopeParam.percent(
          'Late %',
          'lateDeadPct',
          countColumn: 'lateDeadCount',
          bmkField: 'lateDeadPct',
        ),
        ScopeParam.percent(
          'Ext pip %',
          'externalPipPct',
          countColumn: 'externalPipCount',
          bmkField: 'externalPipPct',
        ),
        ScopeParam.percent(
          'Crack %',
          'crackedPct',
          countColumn: 'crackedCount',
          bmkField: 'crackedPct',
        ),
        ScopeParam.percent(
          'Contam %',
          'contaminatedPct',
          countColumn: 'contaminatedCount',
          bmkField: 'contamPct',
        ),
      ],
    ),
