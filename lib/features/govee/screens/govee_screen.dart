...
import '../widgets/govee_review_sheet.dart';
import '../widgets/govee_scope_picker.dart';
import '../widgets/govee_spot_recorder.dart';

class GoveeScreen extends StatelessWidget {
            ...
            children: [
              ...
              if (provider.phase == GoveeSpotPhase.review) ...[
                ...
                GoveeReviewSheet(
                  ...
                  onSave: (labels) => _saveWithReplacementConfirmation(
                    context,
                    provider,
                    labels,
                  ),
