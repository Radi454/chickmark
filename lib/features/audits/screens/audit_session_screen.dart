...
import '../logic/panel_row_to_draft.dart';
...
class _StationFrameState extends State<_StationFrame> {
  ...
  // Delegates: the implementations moved to `logic/panel_row_to_draft.dart`
  // with the panel-row merging, but the row-reading code left behind here
  // still needs them. Delegating keeps a single implementation.
  int? _asInt(Object? value) => panelRowAsInt(value);

  String? _asText(Object? value) => panelRowAsText(value);
