...
class ChickQualityScreen extends StatefulWidget {
  ...
  const ChickQualityScreen({super.key, required this.context});
            ...
            child: TabBarView(
              ...
              children: [
                ...
                WeightsTab(
                  ...
                  onSave: () => auditProvider.saveTab(2),
                ),
                YfbmTab(
                  audit: auditProvider.activeDraft,
                  isReadOnly: auditProvider.isReadOnly,
                  ...
                  onSave: () => auditProvider.saveTab(3),
                ),
                CvtTab(
                  audit: auditProvider.activeDraft,
                  isReadOnly: auditProvider.isReadOnly,
                  ...
                  onSave: () => auditProvider.saveTab(4),
                ),
              ],
            ),
          ),
